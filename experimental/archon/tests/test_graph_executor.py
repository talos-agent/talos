...
class TestGraphExecutorWithMockedIPFS:
    ...
    @pytest.mark.asyncio
    async def test_execute_stored_graph(self, sentiment_graph_builder, setup_ipfs_mocks):
    ...
    @pytest.mark.asyncio
    async def test_type_aware_execution(self, sentiment_graph_builder, setup_ipfs_mocks):
