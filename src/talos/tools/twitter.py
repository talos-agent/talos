"""
A tool for interacting with Twitter.
"""


def read_posts(query: str) -> str:
    """
...
def reply_to_tweet(tweet_id: str, reply: str) -> None:
    """
    Replies to a tweet.
    """
...
def get_all_replies(tweet_id: str) -> list[str]:
    """
